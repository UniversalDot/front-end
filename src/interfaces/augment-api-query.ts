...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    dao: {
       ...
       **/
      applicantsToOrganization: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Vec<AccountId32>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       * Storage item that indicates which DAO's a user belongs to [AccountID, Vec]
       **/
      memberOf: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Bytes>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Create organization storage map with key: name and value: Vec<AccountID>
       **/
      organization: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Vec<AccountId32>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       * OrganizationCount: Get total number of organizations in the system
       **/
      organizationCount: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Create organization storage map with key: name and value: Vec<Hash of task>
       **/
      organizationTasks: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Vec<H256>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       * Store Vision document in StorageMap as Vector with value: AccountID, BlockNumber
       **/
      vision: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<ITuple<[AccountId32, u32]>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       * VisionCount: Get total number of submitted Visions in the system
       **/
      visionCount: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    grandpa: {
       ...
       **/
      setIdSession: AugmentedQuery<ApiType, (arg: u64) => Observable<Option<u32>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
    ...
    profile: {
       ...
       **/
      profileCount: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Stores a Profile unique properties in a StorageMap.
       **/
      profiles: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletProfileProfile>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    system: {
       ...
       **/
      blockHash: AugmentedQuery<ApiType, (arg: u32) => Observable<H256>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      extrinsicData: AugmentedQuery<ApiType, (arg: u32) => Observable<Bytes>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    task: {
       ...
       **/
      taskCount: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Tasks: Store Tasks in a  Storage Map where [key: hash, value: Task]
       **/
      tasks: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<PalletTaskTask>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Keeps track of which Accounts own which Tasks.
       **/
      tasksOwned: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Vec<H256>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
